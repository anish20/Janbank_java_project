            ...
            <header>
                ...
                <div align="center" style="padding: 20px;">
                    ...
                    <table cellpadding="6">
                        <tr>
                            <td>Account No</td>
                            <td><input type="text" name="acn" style="width: 100%;" placeholder="Account No"required=""></td>
                        </tr>
                        <tr>
                            <td>Account Holder</td>
                            <td><input type="text" name="nm" style="width: 100%;" placeholder="Account Holder Name" required=""></td>
                        </tr>
                        
                        <tr>
                            <td>Deposit Amount</td>
                            <td><input type="text" name="amt" style="width: 100%;" placeholder="Amount" required=""></td>
                        </tr>
                        <tr>
                            
                            <td colspan="2" align="center"><input type="submit" name="btn" value="Deposit">
                ...
                if(msz!=null){
                    out.print("<mark>"+msz);
                    out.print("<a href='Deposit.jsp' style='text-decoration:none'>&nbsp Close it</a>");
                }
                               %><br>
                </div>
            </div>
