            ...
            <header>
                ...
                <div align="center" style="padding: 80px;">
                    <div style="background: #ffffff;border:solid 1px;width: 60%;">
                      <div style="background: dimgrey;height: 30px;padding: 10px;text-align: left"><b>&nbsp;&nbsp;<font color="white">Message Against Withdrawal Amount And Current Balance</font></b></div><br>
                      <p style="margin: 15px;text-align: left"><font color="green">Amount is Withdrawal Successfully!  & Current Balance is:</font><font color="#FF0000"><%
